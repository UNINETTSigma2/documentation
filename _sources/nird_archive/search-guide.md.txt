...
```{note}
 On mixed-case terms and terms with numbers:
...
What you see in the list of results:
Each result shows a summary of the dataset: the dataset title, the first two lines of its description, the creator name(s), DOI, and file size.
