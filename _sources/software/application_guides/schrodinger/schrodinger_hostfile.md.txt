...
# schrodinger.hosts file examples
## SAGA
```
...
# 1 hour wall time, 32 tasks with default 1 cpu/task
name:        batch-small
host:        login-1
schrodinger: ${SCHRODINGER}
queue:       SLURM2.1
qargs:       --export=ALL --account=nnXXXXk --ntasks=32 --cpus-per-task=1 --time=01:00:00
processors:  1000
tmpdir:      /cluster/work/users/schrodinger
