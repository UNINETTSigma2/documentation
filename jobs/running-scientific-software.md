...
All SLURM jobs get allocated a shared scrach file system pointed to by the vairiable $SCRATCH , but you need to ask for local scratch, like this example where I have asked for 100 Gigabytes of local scratch  :
```
