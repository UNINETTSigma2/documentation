...
| **contact_points**     | `Person`, `Organisaton`| 1...n                | N             | Contact information for people that will be able to answer questions about the dataset. See the **Person** or **Organisation** table below for details on the `Person` or `Organisation` object respectively. |
...
| **creators**           | `Person`, `Organisation` | 1...n                | Y             | The creators or authors of the dataset. See the **Person** or **Organisaton** tables below for details on the `Person` or `Organisation` object. Note: **Only creators appear in the citation for the dataset**. |
