...
<details><summary> <u>Installed versions:</u> </summary>
 ...
 - GATK/4.1.0.0-intel-2018b-Python-3.6.6
 - GATK/4.1.2.0-GCCcore-8.2.0-Java-1.8
 - GATK/4.1.4.0-GCCcore-8.3.0-Java-1.8
</details>
...
<details><summary> <u>Installed versions:</u> </summary>
 ...
 - LINKS/1.8.7-GCC-8.2.0-2.31.1-Perl-5.28.1
</details>
...
###mapDamage
**Description:** mapDamage2 is a computational framework written in Python and R,
 which tracks and quantifies DNA damage patterns among ancient DNA sequencing reads
...
###MITObim
**Description:** The MITObim procedure (mitochondrial baiting and iterative mapping) represents an efficient approach to assembling novel mitochondrial genomes of non-model organisms directly from total genomic DNA derived NGS reads.
...
###MITOS
**Description:** MITOS is a pipeline designed to compute a consistent de novo annotation of the mitogenomic sequences.
**Homepage:** https://gitlab.com/Bernt/MITOS
<details><summary> <u>Installed versions:</u> </summary>
...
###MrBayes5D
**Description:** A modified version of MrBayes.
**Homepage:** http://mrbayes.csit.fsu.edu
<details><summary> <u>Installed versions:</u> </summary>
...
###MSMC
**Description:** This software implements the multiple sequentially Markovian coalescent (MSMC),
            a method to infer population size and gene flow from multiple genome sequences.
...
###MSMC2
**Description:** This program implements MSMC2, a method to infer population
   size history and population separation history from whole genome sequencing data.
...
###ngsDist
**Description:** A program to estimate pairwise genetic distances directly,
 taking the uncertainty of genotype's assignation into account.
**Homepage:** https://github.com/fgvieira/ngsDist
<details><summary> <u>Installed versions:</u> </summary>
...
###ngsLD
**Description:** a program to estimate pairwise linkage disequilibrium (LD)
 taking the uncertainty of genotype's assignation into account.
...
###ngsTools
**Description:** A collection of programs for population genetics analyses from NGS data,
 taking into account data statistical uncertainty.
...
###ntCard
**Description:** ntCard is a streaming algorithm for cardinality estimation in genomics datasets.
...
###ntEdit
**Description:** Fast, lightweight, scalable genome sequence polishing & snv detection.
...
###ntHits
**Description:** ntHits is a method for identifying reapeats in high-throughput DNA sequencing data.
...
###OBITools
**Description:** The OBITools package is a set of programs specifically designed for analyzing NGS
 data in a DNA metabarcoding context, taking into account taxonomic information.
**Homepage:** https://pythonhosted.org/OBITools/welcome.html
<details><summary> <u>Installed versions:</u> </summary>
...
###PALEOMIX
**Description:** The PALEOMIX pipelines are a set of pipelines and tools designed to aid the rapid processing of High-Throughput Sequencing (HTS) data.
...
**Homepage:** https://bitbucket.org/mroachawri/purge_haplotigs/src/master/
<details><summary> <u>Installed versions:</u> </summary>
...
###RADProc
**Description:** An algorithm and software package that streamlines and
accelerates de novo locus formation and catalog building by eliminating
redundancies and using a highly efficient method for nucleotide distance
calculation.
**Homepage:** https://github.com/beiko-lab/RADProc
<details><summary> <u>Installed versions:</u> </summary>
...
###RAxML-NG
**Description:** A phylogenetic tree inference tool which uses
...
###Relate
**Description:** Software to estimate genome-wide genealogies for thousands of samples.
...
###RepeatModeler
**Description:** A de novo transposable element (TE) family identification and modeling package.
**Homepage:** http://www.repeatmasker.org/RepeatModeler/
<details><summary> <u>Installed versions:</u> </summary>
...
###RevBayes
**Description:** RevBayes provides an interactive environment for statistical computation in phylogenetics
...
###RNAmmer
**Description:** RNAmmer  predicts ribosomal RNA genes in full genome sequences
...
###ROHan
**Description:** ROHan is a Bayesian framework to estimate local rates of heterozygosity, infer runs of homozygosity
 (ROH) and compute global rates of heterozygosity.
...
###SHAPEIT4
**Description:** SHAPEIT4 is a method for estimation of haplotypes (aka phasing) for SNP array and sequencing data.
...
###sparsehash
**Description:** An extremely memory-efficient hash_map implementation. 2 bits/entry overhead!
...
**Homepage:** https://www.well.ox.ac.uk/research/research-groups/lunter-group/lunter-group/stampy
<details><summary> <u>Installed versions:</u> </summary>
...
###Sumaclust
**Description:** SUMACLUST is a sequence-clustering application
...
###Tigmint
**Description:** Tigmint identifies and corrects misassemblies using linked reads from 10x Genomics Chromium
...
###VISLCG3
**Description:** Implements the functionality of the VISL CG-2 variant of constraint grammar.
...
###zlib
**Description:** zlib is designed to be a free, general-purpose, legally unencumbered -- that
